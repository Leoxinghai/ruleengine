...
public class BatchConsSummary  implements Serializable {
  private static final String m_whatVersion = "@(#) $RCSfile: BatchConsSummary.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:11 $\n";
   ...
   */
  public BatchConsSummary(int consOidNumber,
                     String consNumber,
