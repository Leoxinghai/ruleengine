...
/**
 * <p>Title: SecLOffView</p>
 *
 * <p>Description: Java class that was derived from the Tuxedo view SecLOnView.
 * The class will be as an argument to the CCIISecurityTuxedoBean.</p>
 *
    ...
    implements Serializable
{
   ...
   * toString
   *
   * @return String - formatted string containing all SecLOffView attributes.
   */
  public String toString()
  {
    String secLOffView = "\nd_returnStatus = " + d_returnStatus +
        "\ns_returnMessage = " + s_returnMessage +
        "\ns_inViewName = " + s_inViewName +
        "\ns_outViewName = " + s_outViewName +
        "\ns_locationCode " + s_locationCode +
        "\nl_sysDateTime = " + l_sysDateTime +
        "\ns_userLogon = " + s_userLogon +
        "\ns_orgCode = " + s_orgCode +
        "\ns_inputDevice = " + s_inputDevice +
        "\ni_errorNumber = " + i_errorNumber +
        "\ni_auditCode = " + i_auditCode +
        "\ns_userId = " + s_userId +
        "\ns_appCode = " + s_appCode +
        "\ns_dutyCode = " + s_dutyCode +
        "\ns_orgCd = " + s_orgCd +
        "\ns_accessList = " + s_accessList;
    return secLOffView;
  }
