...
public class BatchCons  implements Serializable {
  private static final String m_whatVersion = "@(#) $RCSfile: BatchCons.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:11 $\n";
   ...
   * @param updateDate
   */
  public BatchCons(int consOidNumber,
