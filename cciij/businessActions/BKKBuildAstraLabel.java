...
public class BKKBuildAstraLabel extends FileBasedLabel
{
...
//        protected    SimpleDateFormat currTime = new SimpleDateFormat("HHmm");
        ...
        private static final String m_whatVersion = "@(#) $RCSfile: BKKBuildAstraLabel.java,v $ $Revision: 1.2 $ $Author: cvs $ $Date: 2006/09/05 10:09:25 $\n";

        //    LabelDefinitionInterface m_definition;
        public BKKBuildAstraLabel(String as_LabelName) throws Exception
        {
            super(as_LabelName);
 ...
 //               ReadShipment(a_data);
            ...
            if (UrsaEditLoaded == 1)
            {
                ...
                synchronized(uvsdk)
                {
                    ...
                    uvsdk.SetAirbillAndFormCode(a_data.getScan().getAirbillNumber(),a_data.getScan().getAirbillFormType());
                    ...
                    if (LabelProblem == 0)
                    {
                        ...
                        l_printData.put("ASTRAAirbillNumber", a_data.getScan().getAirbillNumber());
                        l_printData.put("ASTRAAirbillFormCode", a_data.getScan().getAirbillFormType());
...
//                        System.out.println("DestinationAirport " + uvsdk.GetDestinationAirport());
                        ...
                        l_printData.put("ASTRAPrefix", uvsdk.GetRoutingPrefix());
//                        System.out.println("RoutingPrefix " + uvsdk.GetRoutingPrefix());

                        l_printData.put("ASTRASuffix", uvsdk.GetRoutingSuffix());
...
//                        System.out.println("Airbill Form Code  : " + a_data.getScan().getAirbillFormType());
        ...
        protected void ProcessServiceHandling(CCIIState a_data)
        {
            ...
            ServiceCode = 11;//Integer.parseInt(s_serviceLine.substring(0,2));
...
//                System.out.println("Need to add Sat Del to Handling codes");
        ...
        protected void FormatDestinationForAstra(CCIIState a_data) throws Java2uvsdkException
        {
            ...
            if (DestinationCountry.length() > 0)
            {
                //i_status = uvsdk.SetDestCountry("SG");
                    ...
                    if (PostalCode.length() > 0)
                    {
                        ...
                        if (i_status != 0)
                        {
                            // Postal Code is somehow invalid, lets try the destinationLoc
                                i_status = 0;
                                i_status = uvsdk.SetDestStation(a_data.getScan().getDestLocationCode());
                                if (i_status != 0)
                                {
