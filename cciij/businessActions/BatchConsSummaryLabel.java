...
public class BatchConsSummaryLabel extends FileBasedLabel
{
    private static final String m_whatVersion = "@(#) $RCSfile: BatchConsSummaryLabel.java,v $ $Revision: 1.2 $ $Author: cvs $ $Date: 2006/09/05 10:09:25 $\n";
    ...
    public BatchConsSummaryLabel() throws Exception
    {
        super("BatchConsSummaryLabel");
    }

    public BatchConsSummaryLabel(String group) throws Exception
    {
        super(group);
    }
...
//        l_printData.put("SEND_FORMAT",new Boolean(true));
	    l_printData.put("BatchTrkNbr",a_data.getScan().getConsId());
		...
		l_printData.put("BatchDestLoc",a_data.getScan().getWarehouseCode());
		l_printData.put("BatchEmpDate","Emp#" + a_data.getScan().getUserLogon() + " "+ new Date());
