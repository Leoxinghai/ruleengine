...
public class SplitsCheck extends BusinessActionBase
{
    ...
    public SplitsCheck() throws Exception
    {
...
//            System.out.println("Split Position " + i_split);
                ...
                (state.getScan().getAirbillEntry().equals("2")))      // this is impossible, do not use ASTRA 
            {
                ...
                s_astraLabel = s_astraLabel.substring(0,32) + Integer.toString(checkDigit);
...
//                            System.out.println("AstraBarcode " + s_astraAB);
    ...
    protected void PerformSplitsCheck(int i_split, CCIIState state) throws Java2uvsdkException
    {
        // Initialize the Splits Context
        uvsdk.SInitialize();
//        System.out.println("SInitialize done");
        ...
        {
            i_status = uvsdk.SplitsCheck();
//            System.out.println("SplitsCheck done, i_status >" + i_status + "<");

            if ((i_status == 1) || (i_status == 2))
            {
                // Package allowed into this split
            }
            else
            {
                // Get the problem message
                int splitAction = uvsdk.GetSplitsErrorNumber();
...
//                    System.out.println("Modified full Date after sub of " + i_daysToAdd + " Days " + s_dateString);
    ...
    {
//        System.out.println("SplitsCheck in main");
