...
public class GenerateAstraLabel extends FileBasedLabel
{
...
//	    protected    SimpleDateFormat currTime = new SimpleDateFormat("HHmm");
	    ...
	    private static final String m_whatVersion = "@(#) $RCSfile: GenerateAstraLabel.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:01 $\n";

	    //    LabelDefinitionInterface m_definition;
	    public GenerateAstraLabel(String as_LabelName) throws Exception
	    {
	        super(as_LabelName);
