...
import cciij.cciidatabase.DatabaseBean;
	...
	public abstract class BKKADDTOCONSCoreProcessor extends BusinessActionBase {

			private static final String m_whatVersion = "@(#) $RCSfile: BKKADDTOCONSCoreProcessor.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:01 $\n" ; 

		    public BKKADDTOCONSCoreProcessor() throws Exception {
			traceLog("VerifyScanBase","In Constructor");
		    }

		    public BKKADDTOCONSCoreProcessor(String groupName) throws Exception
		    {
			super(groupName);
