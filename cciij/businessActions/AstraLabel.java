...
//
//      $Source: /home/cvsroot/fedexccii/src/cciij/businessActions/AstraLabel.java,v $
//      $Revision: 1.1 $
...
public class AstraLabel extends FileBasedLabel
{
...
//    protected    SimpleDateFormat currTime = new SimpleDateFormat("HHmm");
    ...
    private static final String m_whatVersion = "@(#) $RCSfile: AstraLabel.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:01 $\n";

    //    LabelDefinitionInterface m_definition;
    public AstraLabel(String as_LabelName) throws Exception
    {
        super(as_LabelName);
...
//                  System.out.println("Looking for Service " + m_splitFormat[j+166] + " " + servicePriority[i]);
                    ...
                    {
                        // Use this service
                        s_serviceLine = m_config.getValue("SERVICE_CODE_" + serviceValue[i]);
                        ServiceCode = Integer.parseInt(s_serviceLine.substring(0,2));
                        b_notFound = false;
                        break;
                    }
