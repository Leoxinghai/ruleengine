...
public class VerifyRouteStatusAsFlag extends VerifyRouteStatusBase
{
  private  SimpleDateFormat m_df = null;
  private  String m_errorMessage = null;
  private static final String m_whatVersion = "@(#) $RCSfile: VerifyRouteStatusAsFlag.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:01 $\n";

  public VerifyRouteStatusAsFlag() throws Exception
  {
  }
  ...
  {
    if ( routeLeg.getRouteLegStatusCd().equals("Y") == false )
    {
