...
import cciij.util.CCIILogException;
	 ...
	 * Window - Preferences - Java - Code Style - Code Templates
	 */
public abstract class BKKROPCoreProcessor extends BusinessActionBase {

			private static final String m_whatVersion = "@(#) $RCSfile: BKKROPCoreProcessor.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:01 $\n" ; 

		    public BKKROPCoreProcessor() throws Exception {
			traceLog("VerifyScanBase","In Constructor");
		    }

		    public BKKROPCoreProcessor(String groupName) throws Exception
		    {
			super(groupName);
