...
/**
 * Title:       RemoveAllReasonCodes
 * Description: This business action sets the ActiveFlag to false in all the
 *              Reason Codes associated with the Shipment or HandlingUnit.
...
public class RemoveAllReasonCodes extends BusinessActionBaseWithOidGeneration
{
  private static final String m_whatVersion = "@(#) $RCSfile: RemoveAllReasonCodes.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:01 $\n";
  private static final String UPDATE_PROCESS_NAME = "RmAllReasonCodes";
  
  public RemoveAllReasonCodes() throws Exception
  {
  }
  ...
  public CCIIState doIt(CCIIState state, DatabaseBean dbConnection) throws Exception
  {
    ...
    traceLog("RemoveAllReasonCodes", "Beginning doIt()");
    traceLog("RemoveAllReasonCodes", state);
    ...
    traceLog("RemoveAllReasonCodes", state);
    traceLog("RemoveAllReasonCodes", "returning...");
