 ...
 * @version 1.0
 *
 * @throws       java.lang.Exception Unable to read WEB_SERVER_ADDRESS from config file
 * @throws       java.lang.Exception Unable to read QUEUE_JMS_NAME from config file
 * @throws       java.lang.Exception GetInitialContext for JMS queue failed
 * @throws       java.lang.Exception Unable to read ruleset name from config file
 * @throws       java.lang.Exception Queue error exception
 *
 * Modification History:
 *
 * 03/29/02   Ed McAleer  Add QUEUE_JMS_NAME and JMS_FACTORY configuration
 *                        variables to the constructor.
 * 04/16/02   Ed McAleer  Add finalize() method to close JMS connections and sessions.
 */
...
public class BackgroundQueue extends BusinessActionBase {
    private static final String m_whatVersion = "@(#) $RCSfile: BackgroundQueue.java,v $ $Revision: 1.1 $ $Author: xinghai $ $Date: 2006/06/26 07:26:01 $\n";
    ...
    public BackgroundQueue()  throws Exception
    {
